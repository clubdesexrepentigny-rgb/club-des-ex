    ...
    const init = async () => {
      try {
        ...
        for (const key of syncKeys) {
          try { const val=await fbGet(key); if(val!==null){const cur=localStorage.getItem(key);if(JSON.stringify(val)!==cur)localStorage.setItem(key,JSON.stringify(val));} } catch {}
        }
