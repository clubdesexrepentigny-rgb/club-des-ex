...
function ManagerCoffre({ today, history }) {
  ...
  // Calculate coffre chain
  const rows = [];
  let runningCoffre = null;
  ...
  dates.forEach(date => {
    ...
    const coffrePrev = runningCoffre ?? 0;
    const coffreCalc = coffrePrev + depotCoffre - totalSortie;
    runningCoffre = coffreCalc;
