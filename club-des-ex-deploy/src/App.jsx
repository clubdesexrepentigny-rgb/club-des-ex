...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.error) {
      return (
        <div style={{padding:30,background:"#1a1a1a",minHeight:"100vh",color:"#fff"}}>
          <h2 style={{color:"#ef4444"}}>⛔ Erreur</h2>
          <p style={{color:"#fbbf24",fontFamily:"monospace",fontSize:".85rem",whiteSpace:"pre-wrap"}}>{this.state.error?.message}</p>
          <p style={{color:"#fbbf24",fontFamily:"monospace",fontSize:".75rem",whiteSpace:"pre-wrap"}}>{this.state.error?.stack?.slice(0,500)}</p>
          <button onClick={()=>window.location.reload()} style={{marginTop:20,padding:"10px 20px",background:"#e8a020",border:"none",borderRadius:8,cursor:"pointer",fontWeight:700}}>Recharger</button>
        </div>
      );
    }
