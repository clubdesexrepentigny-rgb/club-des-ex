  ...
  return (
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",
      ...
      <div style={{display:"flex",flexDirection:"column",gap:12,width:"100%",maxWidth:300}}>
        <input type="password" value={input} placeholder="Mot de passe..."
          autoFocus
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      try {
        await initAuth();
        const keys = ["manager_pin","employees","inventory","history",
          "prices","custom_products","cocktails_v2","sheet_"+today];
    ...
    <>
      ...
      {!online && (
        <div style={{position:"fixed",top:0,left:0,right:0,zIndex:9999,
          ...
          fontSize:".75rem",padding:"4px",fontWeight:600}}>
